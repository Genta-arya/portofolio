  ...
  return (
    <>
      <div className="overflow-hidden   ">
        <div className="font-bold md:w-full w-40 text-sm md:text-xl mb-2 shadow-none lg:hidden md:block hidden">
          {truncateName(project.name, 40)}
        </div>
        <div className="font-bold md:w-full w-40 text-sm md:text-xl mb-2 shadow-none lg:hidden md:hidden">
          {truncateName(project.name, 20)}
        </div>
        <div className="font-bold w-80 text-sm md:text-xl mb-2 shadow-none lg:block hidden md:hidden">
          {truncateName(project.name, 29)}
        </div>
